...
function updateFilterUI(filterType) {
    ...
    const desktopButtons = document.querySelectorAll('.filter-buttons-desktop .filter-btn');
    ...
    const mobileButtons = document.querySelectorAll('.filter-buttons-mobile .filter-btn-mobile');
